...
public class MessageTextController extends BaseController
{
    ...
    @Log(title = "文本列表", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, MessageText messageText)
    {
        ...
        util.exportExcel(response, list, "文本列表数据");
    }
    ...
    @Log(title = "文本列表", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "文本列表", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "文本列表", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
